...
public class VideoChannel implements Publisher{
    ...
    @Override
    public void registerSubscriber(Observable observer) {
    ...
    public void notifySubscribers(Video video) {
        for (Observable observer: subscribers){
            observer.process(video);
        }
    }

    @Override
    public void deleteSubscriber(Observable observer) {
